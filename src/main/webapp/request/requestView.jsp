...
<script>
	$(function(){ 
		$('input[type="submit"]').on('click',function(){
			methodVar = $('input[name="gp"]:checked').val()
			$('form').attr('method',methodVar)
		})
...
<body>
	<%-- 파라미터  : client 서버로 요청을 보낼 때 추가적으로 보낸 값
	  ...
	  <%--  한글 파라미터 설정
	  		...
	  		post : request.setCharcterEncoding("utf-8");
	  ...
	  <form action="${pageContext.request.contextPath }/request/requestResponse.jsp" method="get">
	  	...
	  	GET<input type="radio" name="gp" value="get">
	  	POST<input type="radio" name="gp" value="post"><br>
	  <br><br>
